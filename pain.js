...
var legendoDon = {
    ...
    a10: {
        text:'As you wait for the other two to awaken, you realize that it won\'t be peaceful for long. Don: "Shit, they won’t be awakening anytime soon and I can hear the creatures crawling out already” <br></br>Inside the dungeon of Crystal Lake are crystal-covered floors and when you look up, the constellations appear in the starry sky. Throughout the day it was pretty peaceful, but as nightfall continued, the sound of udashes (wolf creatures located in dungeons) started to come around.  A minute later, a status window appears <br></br>Creature: Udashes <br></br>  About: Fairly territorial, touching its items is not recommended and will hunt down their prey in groups. <br></br>If encountered, use fire Stats: 120/120 hp<br></br> Dont: “Dam my mana depletion, stupid window! UGH I told you not to deplete” How will you deal with this situation?' ,
    ...
    a12: { 
        text:'After using a torch to ward off the udashes, you expended too much of your mana and had to rely on the little that’s left. <br></br>WARNING <br></br> USER: DANTE Mana error: Insufficient mana <br></br>Mana Pool: Inaccessible<br></br> As  your mana quickly depleted, you closed your eyes for what was coming next when suddenly, the necklace your mother gave you as a child started to glow. You realize that your status window opened. <br></br> Avatar: Dante <br></br> Status: Healed <br></br> Strength: 500/800 <br></br>Level: 34 <br></br>Mana: Depleted <br></br>Pressure Points: Recovering <br></br>After it tells you that your pressure points have been unlocked, not questioning it, you summon a fire ring both burning and wearing the udashes off . As you scroll through your window of spells, you try to find an awakening spell. <br></br> Welcome! How can I help you: Dante <br></br> Spell book <br></br> Avatar Status<br></br> Creatures<br></br> Other <br></br>After finding a spell with the condition that the users are in a crystal lake, you cast it on them and they awaken two days later.',
        options:[['cp3', 'Continue...'] ],
    }, 

    a13: { 
        text:'After using your teleportation scroll, you find yourselves in another part of the dungeon. Don: “Where are we? I mean at least we’re safe-ish" As another two day passes, you find that your pressure points are starting to loosen and before exhausting yourself again, you search for an awakening spell. <br></br>Hello Dante!<br></br> Awakening spell (4)<br></br> Other 3 unavailable, opening 1. . .<br></br>Requirements: mana stone, summoning <br></br>circle, and barrier <br></br>As you cast the spell along with a barrier, you find them awakening after eight hours. <br></br>Warning! Dante Critical Condition!<br></br>Mana depleted!<br></br> Life flashing!<br></br>Get back to safe zone<br></br> When they awoke, they found you in critical condition due to mana depletion, Darcy immediately transferred some of her mana into you hoping to release your pressure points. When you awoke, you found your pressure points had been unsealed, but the backlash had left you asleep for two days.<br></br> Avatar: Dante <br></br> Status: Healed <br></br> Strength: 500/800<br></br> Level: 34 <br></br>Mana: Depleted <br></br> Pressure Points: Recovering ',
        options:[['cp3', 'Continue...'] ],
    }, 

    a14: { 
        text:'Avatar: Dante <br></br>Status: Healed <br></br>Strength: 500/800 <br></br>Level: 34 <br></br> Mana: Depleted <br></br>Pressure Points: Recovering<br></br> Don: “Now how will the others wake up…”',
        options:[['a16', 'While I wait, minus well look for a cure'],['a17', 'Maybe my powers will work??'] ],
    }, 

    a15: { 
        text:'you have given the elixir to Darcy and Joel, they have awoken successfully and after seeing your act of selflessness, the fairy appeared warning you about your powers. <br></br> Welcome! Dante <br></br>Message:<br></br> “Hello adventurer, I see you’re doing fine, seeing as you were using too much mana, you were stripped of your powers.  <br></br>Powers: Recovering now . . . <br></br> Because of what you did I shall return to you these.<br></br> Last warning: beware of ṯ̵͍͈̟̃h̵͎͒ȅ̵̞̮̳̈́̒ ̶̹̜̃̈́w̴̧̛̹̩̫̄̊͒͆̃̕̚͜͝͝ḯ̸̛̫̏̈́̏͒͝ḋ̴̩-o̵̺̹͆̒͗̔̚̕w̸͖̳͚̩̞̮̜͙̉͂̿̌͛̚͝ͅ,̴̢̡̳͈̗̣̼̝̋̑͘ ̶̡̨̞̤̣̤̝̱̽̕̕h̴̩̥̖̪͊͑̇̅̉͒ͅe̷̺̠̺̠̟̺͎̭̞͗̍͑̐̐̾̿̑͗͂  Is not on your side!” After completing your goal, you three reach the boss room. ',
        options:[['cp3', 'Continue...'] ],
    }, 

    a16: { 
        text:'After waiting for two days, they showed no sign of improvement and so you grabbed some of your rewards from the last dungeon. As you pulled out the virtual book Cade gave you, you started searching for an elixir that would awaken them. Using the Ahgif’s foot, some of the crystal powder, and some of your infused mana, <br></br>Potion Successfully made! <br></br>Shortly after drinking it, they awoke and you filled them in on where they’re currently at and what happened over the past week they were asleep.',
        options:[['cp3', 'Continue...']],
    },
    ...
    a18: { 
        text:'After continuously attacking the hollow while its defenses are dropped, you finally slay him: Your window appears:<br></br>The Hollow whispers to you:“When  you start to fear, and the shadows come to sense, the monsters will tear, the wall of your fence.” <br></br>After seeing the other two hadn’t received this message, you kind of prodded it off. Additionally you, Darcy, and Joel were awarded a headpiece, mana crystals, and an unknown cube that can be opened under specific conditions.<br></br>Joel: “Hey, can I have the headpiece?” <br></br>Darcy: “Yeah, Uh, Don what did you want?” <br></br> Donn: “MH i’ll take the mana crystals, Darcy, you can take the cube?” <br></br>Darcy: “Sure, whatever works with you?” It was decided that the cube goes to Darcy, I get the mana crystals, and Joel gets the headpiece.<br></br> Items added to inventory! <br></br>Dante: +130 exp points',
        options:[['cp4', 'Continue...']],
    },

    a19: { 
        text:'After slaying the Hollow, you have gained the rune of the mist, Although you cannot harness water mana, you can certainly learn or you can give it away.  As for the other rewards like a tree spirit, rengi crystals,  enchantment book, a casters wang, upgraded swords, and daggers, they were offered to Jeol and Darcy. When Darcy made the contract with the mud spirit, she had whispered to you: <br></br>“When  you start to fear, and the shadows come to sense, the monsters will tear, the wall of your fence.”<br></br>  Don: “Odd, hey Darcy. Are you pulling my leg?” <br></br>Darcy:”No, why would I?” <br></br> Don: “Not literally, I mean did you hear that?”<br></br> Darcy: “Are you okay? Do you want to get your head checked”<br></br> Don: “Naw, we’re good let’s get out of here”',
        options:[['cp4', 'Continue...']],
    },
    // DIVISION CP4 
    cp4: { 
        text:'Don: “Hey? Meet up again in 2 months? I kinda wanna explore more dungeons ya feel” <br></br>Joel: “Sure, just call me, you know my address”  <br></br>Darcy: “Definitely! This was fun” <br></br>Don: “Alright! Take care, cya in a couple months” On the second week of the month, you enter the river of Eden to start training on your own. When you search your inventory, you see that your egg has hatching properties, if properly nurtured, it’ll hatch into a creature depending on the user. After heading back to town to buy an incubator, you went back to the river plains where you slayed wurheds for experience. You learned that the experience you earned had gone to the egg, not knowing that the kind of experience you earned would affect the kind of creature you hatched. After a month and three weeks, a week before meeting Darcy and Joel again, you finally hatched your egg. <br></br>The window appeared: <br></br>“Congratulations! You have successfully hatched a fire breathing sea hybrid.<br></br>  Attributes: flame bullet <br></br>Water barrier<br></br> Water ferry<br></br>   Healing mist <br></br> Flame mist<br></br> Health: 250/280 hp<br></br> Armor: 2/50 <br></br>Excited to meet Darcy and Joel once again to introduce them to your new pet, Silica, you end up arriving earlier than the other two.',
    ...
    a22: { 
        text:'Don: “Hey hop on, I couldn’t introduce her but look at my new companion. Kinda sick right” Joel: “Yoo, where did you get a pet like that??” <br></br>Darcy: “That’s really cool, can’t believe i get to ride on her” <br></br> Don: “Right!? It’s time to get going, I’ll introduce her officially later”<br></br> On top of Silica, you guys went down under and unfortunately, you guys found nothing. As you guys approach the ocean floor, you see a small hole with light seeping through. Finding that there was nothing there, you guys return back up for air. Upon your return to the surface, Joel starts pointing out that the clouds look like a chicken riding an ostrich. He then notices a weirdly shaped rock with a gleaming light from it. As you guys approach it, you see that it contains crystals (geode crystals). <br></br>Your window appeared: <br></br>Legend has it that if you eat a sea shard you will awaken in Atlantis. The villagers offer food and send out candles into the water to ease the wrath of Poseidon. Will you take the shard or go back under to find a different path?',
    ...
    a25: { 
        text:'On the count of three…1…2…3! You guys shut your eyes in preparation for death or suffocation at the most, to your surprise, the answer was right in front of you guys. Your window appeared:<br></br>Third Dungeon has begun! Congrats on making it to Atlantis!<br></br> Your goal: Find Poseidon’s three artifacts and return them to his Castle. First, find  your way into the actual city! <br></br> You are at the border! <br></br>After you close the window, you guys wander around when you realize that in the center of the border are two large crumbled buildings that seemed to have a stairway underneath. When you guys go down the stairs, you see inscriptions with instructions to find an opening in the border. Will you follow those instructions? ',
    ...
    a27: { 
        text:'After deciding not to risk your life, you guys decide to call it a day and sleep. The next morning, Joel  decides to take a swim and while he’s out swimming around the coral reef, a sharp glass object cuts him. He found it weird because instead of bleeding, he seemed to be drawn to it. When he brings a handful of pieces back, Darcy and you  start to analyze it and  realize that inside is what seems to be a pearl? Darcy realizes that if used correctly, these geode shards can actually be used as a medium to Atlantis.<br></br>After taking the shards, you guys find yourselves in the city of Atlantis. Your window appeared:<br></br>Third Dungeon has begun! <br></br>Congrats on making it to Atlantis! Your goal: Find Poseidon’s three artifacts and return them to his Castle. First, find  your way into the actual city! You are at the border! <br></br>After you close the window, you guys wander around when you realize that in the center of the border are two large crumbled buildings that seemed to have a stairway underneath. When you guys go down the stairs, you see inscriptions with instructions to find an opening in the border. Will you listen?',
        options:[['a30', 'Find the opening that the inscription told you about.'], ['a31', 'Just play around with the items in the room you found the inscriptions in']],
    }, 
    ...
    b4: {
        text: 'Cade looks at you oddly. Wanna go?<br></br> Cade: “Sure I guess, won’t need it but you do you bud, here I’ll hit up Darcy, she’ll be home tomorrow at dawn. Get along well kiddos” <br></br>Dante: “Sure? There any peeves I need to be ware of” <br></br>Cade: “Nah, she’s cool, she grew up in the forest so she knows her way round. Anyways you guys set off in two days, I need you to go grab some ingredients. If I have extra, I’ll make you a flame elixir for your mana”<br></br>  Once you guys set out, you found yourselves traveling for quite a while. After three hours on the road, you guys called it a night and continued up the mountains at dawn. You both lay under the stars. As you guys gaze, <br></br>Darcy asks:<br></br> Darcy: “Hey, what’s your name? <br></br>Dante: “Bro you ask now????  It’s Dante” <br></br>Dacry: “Alright, we set off tomorrow, good with you?” <br></br>Dante : "Yeah, sounds good, where are we starting off first?” <br></br>Darcy: “No clue, the list he gave us is in my inventory, we should be okay after making it up to the mountains” <br></br>After talking for a bit longer, you guys sleep and get up early the next morning. After another month of traveling passes, you guys end up finishing and returning to Cade. Upon giving the contents of the quest to him, you and Darcy leave after. <br></br>Darcy: “Hey Don, up for a quest?” Wanna go?',
        options: [['b8', '“Definitely, what are we doin?”'], [' b9','“Maybe later? I’mma go back to Cade I needed to grab something”']],
    },

    b5: {
        text: 'Cade: *Sigh* kids these days don’t get anything done eh, fine it’s good instead you can go into the forest. Here, I’ll give ya a map, take it and go explore, there’s plenty to learn from there. Don’t come back till it’s clear. Will you listen to the second request? <br></br>Dante: “Thanks….sorry again Cade” Cade: “It’s fine, can’t force a kid to go ya know” Will you listen to the second request?',
    ...
    b7: {
        text: 'As you cluelessly wander around, you stumble upon a misted forest where you hear the cries of what sounds like a person? As you go further into the forest confused, you see an ogre with a log chasing a girl? But what was a girl doing this deep in the forest anyway. Your window appears: <br></br>“Welcome!I am Window! I am here to help you along your adventures. As you encounter new creatures and quests, you will see me a lot!<br></br> Creature ahead: Urlog<br></br>  Descriptions: Attacks indiscriminately when someone touches their items or enters their plot of land”<br></br> As you go to see how you can help, you end up throwing a log, after the ogre flinches away, you grab the girl and flee. Once you guys get into a safe vicinity,you ask her for her name. <br></br>Girl: “Hey, thanks, you saved me back there, for thy, I am thankful. My names Darcy, and you?”  <br></br>Dante: “np, I just got myself saved too lmao, name’s Dante”  <br></br>After talking for a bit, she casts and throws her palms onto the floor, in confusion you look at the floor then you see a chiseled map on the floor. In amazement, you ask her about it. After answering what ',
        options: [['b14', '“There’s a cabin back in the forest, did you wanna go there?'], ['b15','“Let’s explore the forest?”']],
    },

    b8: {
        text: 'As you walk back into the Cabin, you look around for Cade. <br></br>Dante: “HEY! Cadeee. You here?” <br></br>Cade: “Yeah, what’s up kiddo what d\'ya want?” <br></br>Dante: “Tell me about Dungeons???I’m weak, tryna buff up ya feel?”  <br></br>Cade: “Sure kid, gimme a min want some Coffee?”<br></br> Dante: “Sure” <br></br>After talking with Cade a bit you find out that dungeons are random portals that spawn around the world. By going through them, it’s basically suicide if you can’t beat the boss. Without defeating the dungeon, you can’t beat the boss.',
        options: [['bcp1', 'Continue...']],
    },
    
    b9: {
        text: 'Darcy: “I heard that there’s a bunch of flowers blooming on the windland hills, did you want to go” <br></br>Dante: “Sure, where to first captain” As you guys start heading up for the Windland hills, you start to feel a bit cold. The wind starts to blow harder and you lose your footing.<br></br> Darcy: “HEY DON,  ARE YOU OKAYYYY!”<br></br> Dante: “Yeah, I’m good, did you want to find your way down? There’s another guy down here, he just walked through what looks like a black hole?”',
        options: [['bcp1', 'Continue...']],
    },

    b10: {
        text: 'Cade: “Sure, 6 am sharp, meet up with Joel and Darcy, don’t be late”<br></br> After meeting up with Darcy and Joel, you guys introduce yourselves and end up heading out for the highLands where the swamps are dominant. Upon setting out, you guys stumble upon a key and a chest.<br></br> Joel: “Hey so who wants to open it?” <br></br>Darcy:”I’m just tagging along, I didn’t want to come..”<br></br> Dante:”...” <br></br>Joel:”So?”<br></br> Dante:”I’ll do it…”<br></br> After you insert the key into the chest, a portal opens in its place.',
        options: [['bcp1', 'Continue...']],
    },
    b11 : {
        text: 'Cade: *Sigh* go ahead kid” As you set off, you start heading for the Highlands where you accidentally stumbled through a hole in the ground. After falling a couple feet below the ground, you find yourself in a hole with two other people.<br></br> Dante: “I don’t know where I am, you” <br></br>Joel: “No clue” <br></br> Darcy: “Nope, i was practicing creating mud soldiers when i was brought here by them” <br></br>Dante: “Names, Dante” Joel: “Cool, I’m Joel” <br></br>Darcy: “Names Darcy, I’m from the elven kingdom, pleasure to meet you” <br></br> Dante; “So what do we do?” <br></br>After discussing it for a bit, a random portal appears.',
        options: [['bcp1', 'Continue...']],
    },
    ...
    b16: {
        text: 'As you guys continue inspecting the room for clues on how to get out, Joel finds an encrypted piece of paper. While trying to decipher it, Darcy speaks up. <br></br>Darcy: “Hey, guys, I think it’s in Elven, this seems to be my language. It’s really old since I don’t know it but from what I can tell, it seems to be a potion recipe” <br></br>Joel: “Well? Can you decipher it or not?”  <br></br> Don: “HM, do you think the Window knows?” <br></br>You try pulling up window <br></br> Welcome Dante! What do you want to do?<br></br> Spell book<br></br>  Avatar Status <br></br>Creatures <br></br>Other <br></br>After trying to use the window to decipher the recipe, you guys get as far as to know you need to create three potions with the given ingredients. It is missing one ingredient hence the options on the podium, each one of the people in the room will make one. <br></br>Welcome to your first quest: <br></br>You will create a potion, each of you, with the given ingredients: A rabbit’s foot, a toad’s tongue, or snake venom. You are trying to make an elixir of light, this potion will come to use later. Which kind of potion will you make?',
    ...
    b17: {
        text: 'Before casting your explosion you hear a yell. <br></br>Darcy: “WHAT are you doing!”  <br></br>Joel:”At least take some precautions?!?” <br></br> Darcy: “Give me a warning ahead of time, let me put up a shield before you kill us you nugget” <br></br>Don: “Sorry… but y\’know I was gonna cast one simultaneously” <br></br>Joel: “Can you even do that in your state? I heard it takes a lot of mana” <br></br>Don: “...” <br></br>Darcy: “You really were going to kill us huh” <br></br>Don:”Mb, i\'ll watch it next time lel”  <br></br>Your recklessness may have nearly killed you guys, however nothing ever comes easy anyways. After exploding your way out of the room, you ended up entering the central chamber. When you guys walk closer you see two paths.  <br></br>Joel: “So which path do we take?” <br></br>Darcy: “I don’t know, none of my mud buds are active under here so i can’t send them” <br></br>Don: “Take your best guess guys, we may end here” <br></br>As you guys approach it, you see two paths and an inscription on the wall: Welcome explorer, depending on which path you take, you will be led to your death, or you will be given treasures. Which path will you take?',
        options: [['b21', 'Heyyy, let’s go right eh?”'], ['b22','We cannot go wrong with left”']],
    },

    b18: {
        text: 'Hello, Dante!<br></br> You have successfully created a potion.<br></br>Attributes: ??? <br></br>Contents: Snake Venom <br></br>This potion will be used for a later room, remember your life is in its hand. I do not recommend losing it! <br></br>Despite not knowing whether or not the elixir you guys made is the right one, a door on the right has opened. Upon walking inside, you are led through a dark tunnel with only your flame as a light source. When you guys entered the other side, you found ourselves in an underground tunnel-like place. When you guys go up to the podium, you guys are given instructions.<br></br> Welcome! This is the labor-a-tri. Of the three elixirs that you guys have made, you will all take a sip of one. <br></br>Hint: they say the more you rub it the luckier you get :) Which kind of potion will you guys take? ',
    ...
    b19: {
        text: 'Hello, Dante! You have successfully created a potion.<br></br>Attributes: ???<br></br> Contents: Toad’s tongue This potion will be used for a later room! <br></br>Despite not knowing whether or not the elixir you guys made is the right one, a door on the right has opened. Upon walking inside, you are led through a dark tunnel with only your flame as a light source.When you guys entered the other side, you found ourselves in an underground tunnel-like place. When you guys go up to the podium, you guys are given instructions.  <br></br>Welcome! This is the labor-a-tri. Of the three elixirs that you guys have made, you will all take a sip of one. <br></br>Hint: they say the more you rub it the luckier you get :) Which kind of potion will you guys take? ',
        options: [['b23', 'All or nothing..we should take poison. I mean if we were gonna die anyways, minus well '], ['b24','Let’s take the toad’s tongue one…maybe it’ll work like a prince’s kiss”'] , ['b25','I’m confident! Let’s take the rabbit’s foot”']],
    },

    b20: {
        text: 'Hello, Dante! You have successfully created a potion.<br></br>Attributes: ??? <br></br>Contents: Rabbits foot<br></br> This potion will be used for a later room, remember your life is in its hand. I do not recommend losing it!<br></br>Despite not knowing whether or not the elixir you guys made is the right one, a door on the right has opened. Upon walking inside, you are led through a dark tunnel with only your flame as a light source. When you guys entered the other side, you found ourselves in an underground tunnel-like place. When you guys go up to the podium, you guys are given instructions.<br></br> Welcome! This is the labor-a-tri. Of the three elixirs that you guys have made, you will all take a sip of one. <br></br>Hint: they say the more you rub it the luckier you get :) Which kind of potion will you guys take? ',
        options: [['b23', 'All or nothing..we should take poison. I mean if we were gonna die anyways, minus well '], ['b24','Let’s take the toad’s tongue one…maybe it’ll work like a prince’s kiss”'] , ['b25','I’m confident! Let’s take the rabbit’s foot”']],
    },

    b21: {
        text: 'Darcy: “If i don’t live through this… I\'ll see you guys on the other side” <br></br>Joel:”Right behind you” <br></br>Don: “HM.. it’s okay I am mentally prepared-ish” The right door has opened, before going through, you see from a distance two lights. <br></br>Sorry! Wrong choice, because we are all giving, we have given you a second chance at this. Ahead of you is a puzzle, only the three of you guys can complete it. <br></br>After this warning appears, you guys walk forward where in front of you, you guys see a stone chamber with three stone openings. In the instructions, you are to put your hand into the stone chamber and correctly put the stone shards in the stone chamber. If you guys fail to correctly place the stone tablets, snake venom will be injected into your veins. Each one of the stone tables have an inscription on the-... Error: Incomplete sayying, time running low. Please chose your order! Which order will you enter the stone tablets? ',
    ...
    b23: {
        text: 'Congratulations! <br></br>User(s): Dante, Darcy, and Joel. <br></br>You have drunk a potion of light! Thankfully nothing happened to you and you will now move onto the next and final quest with the others! See you on the other side!<br></br> Now that you have successfully lived through that first experience, a door opened to the left. Upon entering, you guys found yourselves in the boss room.',
        options: [['bcp2', 'Continue...']],
    },

    b24: {
        text: 'How Unfortunate! <br></br>Sorry user(s): Dante, Darcy, and Joel.<br></br> You have chosen the wrong potion. It looks like the gods weren’t on your side today! Once you have died, you will be sent back to the overworld without your memories! I hope you have a happier time there.-Window ',
        options: [['opener', 'Back to the start we go...']],
    },

    b25: {
        text: 'What a shame! <br></br>Sorry user(s): Dante, Darcy, and Joel. <br></br>You have chosen the wrong potion. It looks like your luck has rubbed off! Once you pass away, you will be sent to the overworld without your memories! Have fun in your next life.-Window ',
        options: [['opener', 'Back to the start we go...']],
    },

    b26: {
        text: 'Congratulations! <br></br>You have been thrown into the boss room! <br></br>At least it wasn’t death!',
        options: [['bcp2', 'Continue...']],
    },
    ...
    b28: {
        text: 'How Unfortunate! <br></br>Sorry user(s): Dante, Darcy, and Joel. <br></br>You have chosen the wrong choice and as a consequence, you have been bestowed death by the ǧ̸̡̣͎̖̗̲̇o̷̡̩̗͙̻̤͓̠̍̏̓̅̋͗̊̕d̵̺͙̮̎̾̊̽̃̍͑ś̵̟͕̠̏͜ . Good Luck next time-Window',
        options: [['opener', 'Good Luck next time! Back tot start you go.']],
    },

    b29: {
        text: 'Joel: “HEY GUYS, I see an armor chestplate over here I’m going to take it!” <br></br>Darcy:” Sure, I found some mana scrolls, I’m also taking something, what about you Don?” <br></br>Don: “Yeah, on it, I’m taking this  windbook spell”<br></br> Darcy: “HEY, while you’re there can you grab some crystal shards?”<br></br> Don: “Yeah that’s right Cade wanted some. I got it dw” <br></br>After grabbing your desired object(s) the ceiling started to collapse and so you guys ran out of the door you came through. Instead of finding yourselves in the trap room again, you guys are now inside the boss room.',
        options: [['bcp2', 'Continue...']],
    },

        // DIVISION cp 2
    bcp2: {
        text: 'Fellow adventurers, you have been forced into the dungeon. After the platform rose, you guys found yourselves in the middle of a summoning circle. Surrounded by four stones in a diamond formation, Sapphire, Ruby, Moonstone, and Emerald, you guys stared around in confusion. Without being able to think properly, something started to happen, after running out of the circle, you guys see a creature summoned.<br></br>“Welcome to the Boss Room.<br></br> Your goal is to beat the Finnoe and successfully reclaim the stones. After beating this boss, you can reclaim the four stones, use it to level up or for future dungeons. <br></br>Sapphire Attributes: used for creating red powder (extremely deadly) and for creating t̶̮͈͙͚͔͎͎̙̲̄̂h̵͇̠̯̾̇e̸̙̗̥̯̓̀̑̏̄̅͌̚ ̶̳̺͖̾͒͝a̸̢̯̲͆͌l̵̯̱̞̼̬̖̮͍̭͕͂͑̓́̋͊̈́ḷ̴́̉͛͋͝͠  <br></br>Emerald Attributes: used for bribery or enchanting  <br></br>MoonStone Attributes: can be used for  P̶͉͎͚̱̖͐o̷͙̺̺͎̾͆̀s̵̻͉̞̤̋̃ě̷͓̞͚̠̺͕̺̳̰̿́̃̊̓̑̆̑͠î̴̞̫͔̰̯̗n–n̴̼͓̄̌͌̃ş̵͉̪́͗͗̈́̑̈̈́̇ẗ̷̼̟̹͌̏̑̈́́ <br></br> ERROR: SYSTEM SHUTTING DOWN! No further Information! Check back later.<br></br> In confusion, you, Darcy, and Joel look in front of you where a Finnoe is spawned. Not getting any information about the Finnoe, you guys start to test your limits. After poking around a bit, Darcy realizes that the Finnoe is enchanted by shiny things, but it also has mana. Once agitated enough, it will start to summon destructive mana hulls. How will you go about defeating the Finnoe?',
    ...
    b30: {
        text: 'After agreeing, you guys get into position. Don: “Darcy! Can you guys hold him off?” Jeol:” Yeah! GET ON IT! He isn’t focused for long” Darcy: “Quickly kid, get your head out of the clouds, my mana is depleting, and quickly” As you quicken your pace, you dig around in your bag and window.<br></br> Window! How can i h31p you: Us3r Dante!<br></br>Potion option unavailable: Potion in inventory (1)<br></br> Opening now...<br></br> After trying to cancel the window action, it says error and opening now. Frustrated, you let it open to see what it does. *BOOOOOOM* <br></br>Upon awakening, you find Darcy and Joel hovering above you, without your knowledge, you assumed that Finnoe had died but you hadn’t a clue.<br></br>Darcy: “Hey kid, what’d you do? I saw an explosion in your direction and suddenly we were gone?”<br></br> Joel: “HEY THIS ISN\'T TIME TO CHIT CHAT! LOOK OVER THERE! THE FINNOE MULTIPLIED” <br></br>It occurred to you that the potion had clearly done something, just not in your favor<br></br> Welcome Adventurers! We have helped you! By multiplying the Finnoe, you will now be able to <br></br>d̷͎̱̑̅̏͛́͒́͜-i̸̥̳͝e̸̗̫̼̪̯̦̦̘͆͊̏̎̐̎̅ Error: Shutting down! <br></br>Oddly enough, the window didn’t seem to be functioning inside this dungeon. After poking around more, Darcy, Joel, and yourself had finally made it. After depleting your mana and stamina, you guys finally saw a sapphire. It seemed to be embedded in the wall and quickly crushed it. Recalling what the window said earlier, you guys threw it into its eyes from all sides. After a minute the finnoes slowly fell one by one. After sighing in relief, you guys claim your hard fought rewards and leave. ',
        options: [['bcp3', 'Continue...']],
    },

    b31: {
        text: 'As Joel tried to close in his distance with the finnoe, it would simply send out a hurl that kept him away. <br></br>Joel: “HEY! I can’t go near him?” <br></br>Don: “GIMME A MIN! I can cast a barrier spell around ya” <br></br>Darcy: “QUICKLY! IT\'S COMING” <br></br>After the casting, you guys continue your method and find yourselves rather exhausted and depleted. Putting some mana into Joel’s enchanted sword and Darcy using a mud pillar to launch him, Joel dash at the Finnoe. He took a deep breath and with all his might + the powers you casted on him, he sliced through the Finnoe killing it. After it dropped, its body despawned dropping the four stones. After taking the four stones, you guys leave.',
        options: [['bcp3', 'Continue...']],
    },

    // DIVISION bcp3 
    bcp3: {
        text: 'CONGRATS! You have passed the dungeon of shards. Pardon my connection within the dungeons as it isn’t always well.<br></br> USER(S): Darcy, Joel, and Dante have now been entered into the database.You are now watched. <br></br>After trying to figure out how to avoid being watched the window kicked you out and teleported you onto a hill. After getting out of the dungeon, you guys talk a little more. <br></br>Darcy: “That was definitely a dungeon alright”<br></br> Don: “Fsfs, I hated that, but bro these rewards are helping me big time. I’m going to make my way back to Cade: I have his cave shards, did you wanna raid gain later?” <br></br>Joel: “I don’t know about Darcy, but I’m down, my sword feels so light after infusing it with that emerald”<br></br> Don : “Alright, Cya later! Meet back in 38?” <br></br>Darcy: “Yeah sure”  <br></br>After making your way out, you head back to Cade where you give him the shards. After telling him a bit about your first raid, you go home and sleep for the night. Tired, you relax for the next three days, and then make your way up to the hill to meet the other two. ',
...
function buttonBuilder(btnText, choice){
    ...
    function choiceBuilder(){
        ...
        for(var i = 1; i < storyList.length; i++) {
            myChoices.innerHTML= (prevH + '<br>' + i + '-' + storyList[i])
    ...
    function storyBuilder(text){
        ...
        for (let num of storyList){
            storyPlacer(legendoDon[num].text)
        }
    ...
    // // the restart button, it resets back to the opener
     var restart= document.getElementById("restart")
     restart.addEventListener("click", function(){
        location.reload();
      storyList = ['opener'];
